...
<h3 class="card-title">Edit Register <i>{{$didacticos->nombre }}</i>
...
<div class="card-body">
      <div class="form-group">
        ...
        <input type="text" name="nombre" class="form-control" id="titulofrances" placeholder="Enter name" value="{{ $didacticos->nombre }}">
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" name="cantidad" class="form-control" id="cantidadfrances" placeholder="Enter amount" value="{{ $didacticos->cantidad }}">
          </div>
        </div>
      </div>
