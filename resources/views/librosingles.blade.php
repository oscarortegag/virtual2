...
<h3 class="card-title">English books</h3>
<div class="card-tools">
<div class="input-group-append">
<form action="{{route('librosingles.excel')}}" method="POST" enctype="multipart/form-data">
@csrf
...
<i class="fas fa-edit"></i> New registration
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        @foreach ($material_ingles as $libro)
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="{{ route('librosingles.edit', $libro) }}" class="btn btn-default">Edit</a>
                            </td>
                            <td>
                            <a href="{{ route('librosingles.destroy', $libro) }}" class="btn btn-default deleteLink">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
