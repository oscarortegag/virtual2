...
<h3 class="card-title">Edit register  <i>{{$libros_frances->titulo }}</i>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="titulo" class="form-control" id="titulofrances" placeholder="Enter title" value="{{ $libros_frances->titulo }}">
        </div>
        <div class="form-group">
          <label for="autorfrances">Author</label>
          <input type="text" name="autor" class="form-control" id="autorfrances" placeholder="Enter author" value="{{ $libros_frances->autor }}">
        </div>
        <div class="form-group">
          <label for="editorialfrances">Editorial</label>
          <input type="text" name="editorial" class="form-control" id="editorialfrances" placeholder="Enter editorial" value="{{ $libros_frances->editorial }}">
        </div>
        <div class="form-group">
          <label for="isbnfrances">ISBN</label>
          <input type="text" name="isbn" class="form-control" id="isbnfrances" placeholder="Enter isbn" value="{{ $libros_frances->isbn }}">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="cantidad" class="form-control" id="cantidadfrances" placeholder="Enter amount" value="{{ $libros_frances->cantidad }}">
        </div>
        <div class="form-group">
